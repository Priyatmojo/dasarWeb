...
<html lang="en">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <label>Jenis Kelamin</label><br>
                        <input type="radio" name="jenis_kelamin" id="jenkell" value="L" required="true"> Laki-laki
    ...
    $("#simpan").click(function(){
        ...
        var jenkell = document.getElementById("jenkell").value;
        ...
        if (document.getElementById("jenkell").checked==false && document.getElementById("jenkel2").checked==false) {
        ...
        if (nama!="" && alamat!="" && (document.getElementById("jenkell").checked==true || document.getElementById("jenkel2").checked==true) && no_telp!="") {
            $.ajax({
                type: 'POST',
                url: "form_action.php",
                data: data,
